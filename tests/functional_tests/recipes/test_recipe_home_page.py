...
class RecipeHomePageFunctionalTest(RecipeBaseFunctionalTest):
    ...
    def test_recipe_search_input_can_find_correct_recipe(self):
        ...
        search_input = self.browser.find_element(
            By.XPATH,
            '//input[@placeholder="Seach for a recipe..."]'
        )

        # Clica neste input e digita o termo de busca
        # para encontrar a receita o título desejado
        search_input.send_keys(title_needed)  # typing some text
        search_input.send_keys(Keys.ENTER)  # typing special keys
    ...
    def test_recipe_home_page_pagination(self):
        ...
        # Vê que tem a paginacao e clicar na pagina 2
